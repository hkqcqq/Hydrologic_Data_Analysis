...
```{r}
TN <- filter(LAGOSNandP, state == "ME")
TN2 <- filter(TN, samplemonth == 12)
TN1 <- filter(TN2, tn > 0)
```
...
> Yes, this differ among states. Like ME sampled total nitrogens most extensively in August. But almost every state sampled total nitrogens and total phosphorus most extensively in summer (mainly in July and August).
