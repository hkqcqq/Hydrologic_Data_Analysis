...
```{r}
Threelakesdata <- filter(NTLdata, (lakename == "Peter Lake"| lakename == "Paul Lake"| lakename == "Tuesday Lake") 
                         & (sampledate == "2016-07-25" | sampledate == "2016-07-26" | sampledate == "2016-07-27"))
```
...
>   Lake Name    Epilimnion(m)   Thermocline(m)   Hypolimnion(m)
    Paul Lake      0.0-2.0          2.0-7.5         Below 7.5
   Peter Lake      0.0-1.5          1.5-7.5         Below 7.5
  Tuesday Lake     0.0-1.5          1.5-6.0         Below 6.0
...
Peterdata_Summer_surface <- filter(Peterdata, (Month  == "5" | Month  =="6" | Month  =="7" | Month  =="8") 
                                  & (depth == "0"))
