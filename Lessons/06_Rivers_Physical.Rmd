...
summary(Eno.RImodel) # Discharge = 1332.5 + 1725.8 * log(RecurrenceInterval)
...
> When more data was used, the result will be more accurate. In this case, the prediction of flood events when 30 years data was used is much smaller than using full data.
...
SaladoRecurrencePlotfirst30 <- 
  ggplot(SaladoRecurrencefirst30, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() #+
  #scale_x_log10() 
print(SaladoRecurrencePlotfirst30)

Salado.RImodelfirst30 <- lm(data = SaladoRecurrencefirst30, PeakDischarge ~ log(RecurrenceInterval))
summary(Salado.RImodelfirst30)

#What is the discharge for a 100-year flood in this system? a 500-year flood?
Salado.RImodelfirst30$coefficients[1] + Salado.RImodelfirst30$coefficients[2]*log(100)
Salado.RImodelfirst30$coefficients[1] + Salado.RImodelfirst30$coefficients[2]*log(500)


SaladoRecurrencelatter30 <- 
  SaladoDischarge %>%
  filter(Year > 1985) %>%
  group_by(Year) %>%
  summarise(PeakDischarge = max(Discharge)) %>% 
...
SaladoRecurrencePlotlatter30 <- 
  ggplot(SaladoRecurrencelatter30, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() #+
  #scale_x_log10() 
print(SaladoRecurrencePlotlatter30)

Salado.RImodellatter30 <- lm(data = SaladoRecurrencelatter30, PeakDischarge ~ log(RecurrenceInterval))
summary(Salado.RImodellatter30)

#What is the discharge for a 100-year flood in this system? a 500-year flood?
Salado.RImodellatter30$coefficients[1] + Salado.RImodellatter30$coefficients[2]*log(100)
Salado.RImodellatter30$coefficients[1] + Salado.RImodellatter30$coefficients[2]*log(500)

SaladoRecurrencePlot.Full <- 
  ggplot(SaladoRecurrencefirst30, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() +
  geom_point(data = SaladoRecurrencelatter30, color = "#02818a",
             aes(x = RecurrenceInterval, y = PeakDischarge))
print(SaladoRecurrencePlot.Full)

Salado.RImodel.Full <- lm(data = SaladoRecurrence.Full, PeakDischarge ~ log(RecurrenceInterval))
```
...
GreenRecurrencePlotfirst <- 
  ggplot(GreenRecurrencefirst, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() #+
  #scale_x_log10() 
print(GreenRecurrencePlotfirst)

Green.RImodelfirst <- lm(data = GreenRecurrencefirst, PeakDischarge ~ log(RecurrenceInterval))
summary(Green.RImodelfirst)

#What is the discharge for a 100-year flood in this system? a 500-year flood?
Green.RImodelfirst$coefficients[1] + Green.RImodelfirst$coefficients[2]*log(100)
Green.RImodelfirst$coefficients[1] + Green.RImodelfirst$coefficients[2]*log(500)

GreenRecurrencelatter <- 
  GreenDischarge %>%
  filter(Year > 1960) %>%
  group_by(Year) %>%
  summarise(PeakDischarge = max(Discharge)) %>% 
...
GreenRecurrencePlot.Full <- 
  ggplot(GreenRecurrencefirst, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() +
  geom_point(data = GreenRecurrencelatter, color = "#02818a",
             aes(x = RecurrenceInterval, y = PeakDischarge))
print(GreenRecurrencePlot.Full)

Green.RImodellatter <- lm(data = GreenRecurrencelatter, PeakDischarge ~ log(RecurrenceInterval))
summary(Green.RImodellatter)

#What is the discharge for a 100-year flood in this system? a 500-year flood?
Green.RImodellatter$coefficients[1] + Green.RImodellatter$coefficients[2]*log(100)
Green.RImodellatter$coefficients[1] + Green.RImodellatter$coefficients[2]*log(500)
```
## Closing Discussion
