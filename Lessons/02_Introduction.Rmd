...
Tables, charts
accessible and attravtive and logical color palettes; units; axis lables; legible front sizes; data point sizes-large/small enough; headline(context-dependent); appropriate graph type; axis scales; interactive?
...
<add notes here> Precipitation among the whole country. The amount of precipitation and the states or cities, columns or circles. It will be more easy for people compare the precipitation of different states or cities.
...
<add notes here> The problem with dual axes; Calculation errors; Barplots with racial coordinates; Connet you dots; Overplotting.
