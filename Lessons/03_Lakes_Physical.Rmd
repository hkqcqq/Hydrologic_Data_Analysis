...
<add notes here>there is break between year
```{r}
Tempplot.line <- 
  ggplot(Pauldata.surface, aes(x = sampledate, y = temperature_C)) +
...
epilimnion, hypolimnion, metalimnion or thermocline